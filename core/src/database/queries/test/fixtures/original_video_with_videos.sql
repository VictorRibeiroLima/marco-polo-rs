...
VALUES (9999, 'TestChannel', 9999);
--videos
----
CREATE OR REPLACE FUNCTION populate_videos_for_original() RETURNS VOID AS $$ --function
DECLARE --declaration
  video_id_prefix TEXT := '806b5a48-f221-11ed-a05b-0242ac120';
video_id UUID;
BEGIN --begin
FOR i IN 1..20 LOOP --loop
...
----
-- populate videos
SELECT populate_videos_for_original();